...
export class Output {
     ...
     */
    get lex_output() {
        const ret = wasm.output_lex_output(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    get parse_output() {
        const ret = wasm.output_parse_output(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     * @returns {string | undefined}
     */
    get type_check_output() {
        const ret = wasm.output_type_check_output(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('rjplc_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
