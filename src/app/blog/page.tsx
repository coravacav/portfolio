    ...
    return (
        <div className="py-24 sm:py-32">
            <div className={clsx('mx-auto lg:px-8', pageWidth)}>
                ...
                <HelixAnimation svgWidth="100%" className="lg:mt-10" strokeColor="stroke-raisinBlack" />
                <div className="mx-auto p-4 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {posts.map((post) => (
