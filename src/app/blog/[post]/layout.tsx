	...
	return (
		<div className={thinPageWidth}>
			...
			>
				<Link
					href="/blog"
					className="group my-4 flex items-center gap-2 rounded-lg bg-neutral-900 p-2 text-base leading-6 font-semibold text-white transition-colors hover:bg-neutral-900/50 2xl:text-xl"
				>
					<svg
